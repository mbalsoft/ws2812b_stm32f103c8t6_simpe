...
//#define RESET_LENGTH 36
//#define STATE_LOW    26
//#define STATE_HIGH   59
//#define STATE_100    90
...
//
//  uint8_t test[RESET_LENGTH + 8 * 24 + 1] = {0};
//
//  // Zerowanie kolorów wszystkich diod
//  for (int i = 0; i < 8 * 24; i++)
//    test[RESET_LENGTH + i] = STATE_LOW;
//
//  // Włącz 1-sza zeilona, 2-ga czerwona, 3-cia niebieska
//  test[ RESET_LENGTH + 0 ] = STATE_HIGH;
//  test[ RESET_LENGTH + 24 + 8 ] = STATE_HIGH;
//  test[ RESET_LENGTH + 48 + 16 ] = STATE_HIGH;
//
//  // Stan wysoki na końcu
//  test[RESET_LENGTH + 8 * 24] = STATE_100;
//
